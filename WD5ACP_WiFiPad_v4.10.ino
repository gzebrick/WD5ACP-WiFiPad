#define VER 4.10  // Program Version Number resides here. Change this every time you save - as to a new version number.
...
void loop() { // Main Loop starts here ==================================================================================================================================
  ...
  // Repeated message to keep host connection alive every 7 seconds (host drops after 10 seconds) - Message is power status query to host
