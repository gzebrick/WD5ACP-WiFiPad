...
const int ON_AIR_LIMIT = 600000; // 10 minute timer
const int KEEP_ALIVE_TIME = 4000; // secs * 1000 to tickle host to keep connection alive
const int SLEEP_INTERVAL_SECS = 7200;
