...
#define VER 4.21  // Program Version Number resides here. Change this every time you save - as to a new version number.
...
int lastScreen = 1; // Default last screen is the connect screen
