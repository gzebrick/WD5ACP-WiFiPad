...
#define VER 4.16  // Program Version Number resides here. Change this every time you save - as to a new version number.
...
void drawOnAir()  {  // Screen to pop up when transmitting... // ------------------------------------------------------------------------------------------
  ...
  if ((millis() - onAirTime) > (ON_AIR_LIMIT * 1000)) { // 10 minute trasnmit timer turns ON AIR SCREEN full red
    ...
    gfx.drawString(120, 190, "TIMER EXCEEDED");
  }
